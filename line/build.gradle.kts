...
val publicationVersionName: String = project.requireProperty(name = "publication.line.versionName")
...
publishing {
    configure(
        ...
        artifactId = project.requireProperty(name = "publication.line.artifactId"),
